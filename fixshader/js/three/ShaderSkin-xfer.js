...
ONE.ShaderSkin = {
	...
	'skinSimple' : {
		...
		uniforms: ONE.UniformsUtils.merge( [

			ONE.UniformsLib[ "fog" ],
			ONE.UniformsLib[ "lights" ],
			ONE.UniformsLib[ "shadowmap" ],
			...
			"diffuse":  { type: "c", value: new ONE.Color( 0xeeeeee ) },
			"specular": { type: "c", value: new ONE.Color( 0x111111 ) },
			"ambient":  { type: "c", value: new ONE.Color( 0x050505 ) },
			...
			"offsetRepeat" : { type: "v4", value: new ONE.Vector4( 0, 0, 1, 1 ) },

			"uWrapRGB":	{ type: "v3", value: new ONE.Vector3( 0.75, 0.375, 0.1875 ) }
		...
		fragmentShader: [
			...
			ONE.ShaderChunk[ "shadowmap_pars_fragment" ],
			ONE.ShaderChunk[ "fog_pars_fragment" ],
			ONE.ShaderChunk[ "bumpmap_pars_fragment" ],
			...
			"void main() {",
				...
				ONE.ShaderChunk[ "shadowmap_fragment" ],
				ONE.ShaderChunk[ "linear_to_gamma_fragment" ],
				ONE.ShaderChunk[ "fog_fragment" ],
		...
		vertexShader: [
			...
			ONE.ShaderChunk[ "shadowmap_pars_vertex" ],
			...
			"void main() {",
				...
				ONE.ShaderChunk[ "shadowmap_vertex" ],
	...
	'skin' : {
		...
		uniforms: ONE.UniformsUtils.merge( [
			...
			"uDiffuseColor":  { type: "c", value: new ONE.Color( 0xeeeeee ) },
			"uSpecularColor": { type: "c", value: new ONE.Color( 0x111111 ) },
			"uAmbientColor":  { type: "c", value: new ONE.Color( 0x050505 ) },
...
"#endif",
		...
		vertexShader: [
			...
			"#if MAX_POINT_LIGHTS > 0", //PROBLEM HERE
		...
		vertexShaderUV: [
			...
			"#if MAX_POINT_LIGHTS > 0", //maybe this one?
