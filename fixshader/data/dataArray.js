...
// 			var id = $(this).attr('id');
// 			var title = $(this).find('title[lang="' + 'en' + '"]').text();
// 			var url = $(this).find('url').text();
// 			var text = $(this).find('text[lang="' + 'en' + '"]').html();
...
// 					// $("#infoBoxImage").hide();
// 				}
// 				var button = $(this).find('text[lang="' + 'en' + '"]').attr('button');
				
// 				if( button != null || typeof button != "undefined"){ 
// 					document.getElementById("buttonHolder").innerHTML = "<a id='okay' class='button' href='#'>" +  $(this).find('text[lang="' + 'en' + '"]').attr('button') + "</a>";
// 					// $("#okay").click(function(e) {
// 						// $("#infoBoxBackground").fadeOut(200, function(){
// 							document.getElementById("buttonHolder").innerHTML = null;
// 							if(_id == "todo"){
								showFace = true; //SHOWS THE FACE????
// 							}
// 						// });
						infoBoxOpen = _value;
// 					// });
...
// 					var task = $(this).find('task' + latinSquareLetter + '[lang="' + 'en' + '"]').html();
// 					theTask = task;
